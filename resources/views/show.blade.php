...
@section('content')
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="{{\Illuminate\Support\Str::replaceFirst('thumb','cover_big',$game['cover']['url'])}}" alt="cover">
            </div>
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="mt-12">
{{--                    <button class="flex bg-blue-500 text-white font-semibold px-4 py-5 hover:bg-blue-600 rounded-transition ease-in-out duration-150">--}}
...
{{--                    </button>--}}
                    <a href="https://youtube.com/watch/{{$game['videos'][0]['video_id']}}" class="inline-flex bg-blue-500 text-white font-semibold px-4 py-5 hover:bg-blue-600 rounded-transition ease-in-out duration-150">
                        <svg class="w-6 fill-current" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"></path><path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>
                        <span class="ml-2">Play Trailer</span>
                    </a>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                        ...
                        <div>
                            <a href="{{\Illuminate\Support\Str::replaceFirst('thumb','screenshot_huge',$screenshot['url'])}}">
                                <img src="{{\Illuminate\Support\Str::replaceFirst('thumb','screenshot_med',$screenshot['url'])}}"
                                     alt="screenshot"
                ...
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="{{route('games.show',$similar_game['slug'])}}">
                            <img src="{{\Illuminate\Support\Str::replaceFirst('thumb','cover_big',$similar_game['cover']['url'])}}"
